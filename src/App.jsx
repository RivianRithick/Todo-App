      ...
      <div className="container">
        <form className="row mt-4 g-4 d-flex justify-content-center">
          ...
          <div className="col-md-12 col-lg-3 d-flex justify-content-center">
            <button
              ...
              onClick={() => Add_UpdateToDo(todoName, todoDescription)}
            >
              {buttonAdd}
            </button>
          </div>
              ...
              <ul className="dropdown-menu" aria-labelledby="dropDown">
                ...
                <li>
                  <button
                    ...
                    type="button"
                    onClick={() => setFilterSelect("Completed")}
                  >
                    Completed
                  </button>
                </li>
                <li>
                  <button
                    className="dropdown-item"
                    type="button"
                    onClick={() => setFilterSelect("Not Completed")}
                  >
                    Not Completed
                  </button>
                </li>
        ...
        <div className="row todo-cards-row py-5 d-flex justify-content-center">
          {filteredCards.length === 0 ? (
            <h3 className="h3 text-center mb-4">To-Do is Empty.</h3>
          ) : (
